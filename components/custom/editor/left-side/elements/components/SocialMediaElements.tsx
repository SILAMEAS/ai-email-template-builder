...
const SocialMediaElements = ({socialIcons,outerStyle,style}:Pick<ElementListInterface, "socialIcons"|"outerStyle"|"style">) => {
    return (
        <div style={outerStyle}>
            {
                socialIcons?.map(item=><Link key={item.icon} href={item.url}>
